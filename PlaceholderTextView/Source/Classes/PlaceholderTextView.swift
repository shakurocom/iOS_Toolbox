...
public class PlaceholderTextView: UITextView {
    ...
    override public var intrinsicContentSize: CGSize {
        ...
        if !placeholderTextView.isEmpty() {
            ...
            return CGSize(width: size.width, height: max(placeHolderSize.height, contentSizeBased ? contentSize.height : size.height))
        } else {
            return CGSize(width: size.width, height: contentSizeBased ? contentSize.height : size.height)
        }
    }
    ...
    private func commonInit() {
        NotificationCenter.default.addObserver(self, selector: #selector(PlaceholderTextView.textViewTextDidChange(_:)), name: NSNotification.Name.UITextViewTextDidChange, object: self)
    }
