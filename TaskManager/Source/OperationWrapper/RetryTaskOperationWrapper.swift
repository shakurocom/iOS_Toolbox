...
internal final class RetryTaskOperationWrapper<ResultType>: OperationWrapper<ResultType> {
    ...
    private enum State {
        case executing
        case finished(result: AsyncResult<ResultType>)
    }
    ...
    private func processMainOperationResult(_ mainOperationResult: AsyncResult<ResultType>) {
        // sanity check
    ...
    private func finish(result: AsyncResult<ResultType>) {
